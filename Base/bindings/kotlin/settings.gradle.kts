// Despiabase - the Android face, as its own Gradle build.
//
// Copyright Despia. Licensed under the Apache License, Version 2.0.
//
// Standalone on purpose, exactly as bindings/kotlin-jvm is. This project builds
// `com.despia:base`, the AAR, and it is the `project` the Maven artifact matrix
...
rootProject.name = "despia-base-android"
