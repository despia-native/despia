// Despiabase - the Kotlin/Android face.
//
    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/despia-native/despiabase")
                licenses {
                    license {
                ...
                scm { url.set("https://github.com/despia-native/despiabase") }
