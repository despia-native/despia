...
// shared file. The two are separately published packages - SPM DespiaBase and
// SPM DespiaAI, Maven com.despia:base and com.despia:ai - and a package that
...
#ifndef DESPIA_BASE_JSON_HPP
#define DESPIA_BASE_JSON_HPP
