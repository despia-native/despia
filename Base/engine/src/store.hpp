...
// despia_base.h is implemented here and nowhere else: calls are synchronous,
...
#ifndef DESPIA_BASE_STORE_HPP
#define DESPIA_BASE_STORE_HPP
...
#ifndef DESPIA_BASE_HAS_VEC
#define DESPIA_BASE_HAS_VEC 1
#endif
...
class Store {
 public:
  ...
  // despia_base_reopen. Committed data returns; an open savepoint does not.
