...
anything is a Despiabase snapshot.

## Install

```swift
.package(url: "https://github.com/despia-native/despiabase", from: "0.0.1")
```

```kotlin
implementation("com.despia:base:0.0.1")
```

## Use

```swift
let base = try DespiaBase(directory: appSupportURL)
