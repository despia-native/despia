...
// The MIME + cache tables moved to content-type.ts (platform-free) when the preview face
// arrived; re-exported here so this module's public surface is unchanged.
export { cacheControlFor, contentTypeFor };
