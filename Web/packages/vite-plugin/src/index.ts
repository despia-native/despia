//
//  @despia/vite-plugin v0.1 — compile `.dsx` on import, plus a virtual registry module.
//
...
//  (bundle discipline — this package adds zero runtime dependencies beyond @despia/compiler).
//
...
//      compiles, so a Vite app can boot with @despia/dom.
...
export function emitModule(ir: ComponentIR, css: string, injectCss: boolean): string {
  ...
  const lines = [
    `// generated by @despia/vite-plugin from ${qualified}`,
