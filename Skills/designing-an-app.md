...
>
> Companions: [`writing-an-app.md`](writing-an-app.md) (the language),
> [`thinking-in-dsx.md`](thinking-in-dsx.md) (coming from React Native), the token law in
> [`StackReference.md`](../Documentation/reference/StackReference.md#colors).
...
- **Dismissal returns where you came from.** Back, Close and Skip pop the stack (the
  guarded-back pattern in [`writing-an-app.md`](writing-an-app.md) section 5); a paywall
...
- **The list language.** Screens of rows use the grouped idiom the platform already
  ...
  [`writing-an-app.md`](writing-an-app.md) section 4.
