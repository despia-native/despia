...
> [`dsx-anatomy.md`](../Documentation/reference/dsx-anatomy.md); every element, attribute
> and value is [`StackReference.md`](../Documentation/reference/StackReference.md); markup
> hygiene is [`dsx-best-practices.md`](dsx-best-practices.md). This file is the working
...
> [`thinking-in-dsx.md`](thinking-in-dsx.md) first; before styling anything, read
> [`designing-an-app.md`](designing-an-app.md).
>
> A complete worked app (list, detail, settings, onboarding, paywall) lives in
> [`examples/`](examples/) as a real project you can lint, build and run.
...
- **Each screen is a surface with its own store.** `dsx.variable.*` is local to the
  surface; `dsx.global.*` is shared app state ([`global-state.md`](global-state.md));
...
|---|---|---|
| Layout | `stack` (axis by content), `vstack`, `hstack`, `zstack`, `scroll`, `spacer`, `grid`, `flow`, `scaffold` (safe areas) | [Elements · Layout](../Documentation/reference/StackReference.md#elements) |
...
| Collections | `list`, `grid` with `bind=` + `key=`; the row template is the child markup, row scope is `item` | [Lists](../Documentation/reference/StackReference.md#lists) |
...
- Every list needs its empty, loading and error branches; see
  [`designing-an-app.md`](designing-an-app.md) section 5 for the pattern.
...
- Anatomy + a worked golden template: [`dsx-anatomy.md`](../Documentation/reference/dsx-anatomy.md)
- Every element and attribute: [`StackReference.md`](../Documentation/reference/StackReference.md)
- Design quality bar: [`designing-an-app.md`](designing-an-app.md)
- Coming from React Native: [`thinking-in-dsx.md`](thinking-in-dsx.md)
- Custom gesture-driven controls: [`custom-ux.md`](custom-ux.md)
- Offline + caching behavior: [`offline-best-practices.md`](offline-best-practices.md)
- Backend routes and entities in the same project: [`writing-a-backend.md`](writing-a-backend.md)
